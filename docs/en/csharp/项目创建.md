...
打开安装好的 Visual Studio，如果没有安装的请前往[开发环境搭建](/developer/csharp/开发环境搭建)去安装。

打开 Visual Studio，可以看到这样的启动界面（有可能是英文，请自行查阅如何切换语言），然后点击 `创建新项目(N)` 。

## 创建新项目
![Visual Studio IDE](assets/2026-2-25-VisualStudio-ID0.png)

之后就会进入如下界面：

![创建新项目](assets/2026-2-25-CreateNewProject.png)
...
## 创建控制台应用
![创建控制台应用](assets/2026-2-25-CreateConsoleApp.png)

然后点击下一步，进入到项目配置界面。

## 配置项目
<!-- Configure Project -->
![配置项目](assets/2026-2-25-ConfigureProject.png)

这里就不过多赘述了，都是字面意思。

## 项目信息

![项目信息](assets/2026-2-25-ProjectInfo.png)
